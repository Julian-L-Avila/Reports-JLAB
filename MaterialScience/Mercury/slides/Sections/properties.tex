\section{Propiedades Físicas y Químicas}
...
\begin{frame}{Estructura del Mercurio Sólido}
  \begin{block}{Solidificación y Estructura Cristalina}
    Por debajo de su punto de fusión de $-38.8^\circ C$ (234.3 K), el mercurio
    se solidifica formando un cristal metálico.
    \begin{itemize}
      \item \textbf{Estructura}: Red romboédrica (Grupo espacial $R\bar{3}m$).
      \item Esta puede ser vista como una distorsión de una red cúbica centrada
        en las caras (FCC), aplanada a lo largo de una diagonal principal.
    \end{itemize}
  \end{block}
  \begin{alertblock}{Descubrimiento de la Superconductividad}
    En 1911, H. Kamerlingh Onnes descubrió que el mercurio sólido se convierte
    en un \textbf{superconductor} por debajo de una temperatura crítica de $T_c
    = 4.2\,K$.
    \begin{itemize}
      \item Esta fue la primera observación de la superconductividad.
      \item Demostró una transición de fase cuántica en un elemento puro.
    \end{itemize}
  \end{alertblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \textbf{Reactividad con el Aire:}
      \begin{itemize}
        \item No reacciona con el oxígeno a temperatura ambiente.
          Se oxida lentamente si se calienta para formar óxido de
          mercurio (\ce{HgO}).
      \end{itemize}
      \medskip
    \item \textbf{Reacción con Ácidos:}
      \begin{itemize}
        ...
        \item Sí reacciona con ácidos oxidantes fuertes, como el
          ácido nítrico.
      \end{itemize}
      \medskip
    \item \textbf{Estados de Oxidación:}
      \begin{itemize}
        \item Sus estados más comunes son +1 (mercuroso) y +2 (mercúrico).
      \end{itemize}
  \end{itemize}
\end{frame}
