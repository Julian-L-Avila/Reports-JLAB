...
(\ce{-SH}) en su cadena lateral, además de los grupos caráteristicos y
...
concentración es relativamente alta, los grupos funcionales libres interactuan
...
El enlace \ce{Au-S} es termodinámicamente mucho más estable que las interaccioens
con el citrato provocando que la cisteína desplace a las moleculas
estabilizadoras y modifique la capa dielectrica de la nanopartícula.
...
introduce el \ce{As^{3+}} en la dispersión, este ión actúa como una molécula que
