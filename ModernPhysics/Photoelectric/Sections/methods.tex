...
de potasio en un extremo de una base metálica. A continuación, se colocó un 
diafragma regulable para ajustar la intensidad lumínica, seguido de un filtro 
de color azul de 440 \si{\nano\meter} o ultravioleta de 370 \si{\nano\meter}. 
Finalmente, en el otro extremo de la base metálica, se posicionó la fotocelda. 
