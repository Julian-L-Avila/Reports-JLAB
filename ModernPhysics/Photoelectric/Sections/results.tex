...
del potencial de frenado, en concordancia con el postulado de Planck, según el
cual la energía de un fotón es proporcional a su frecuencia.
...
El ajuste lineal proporciona un valor de \(h = \qty{4.00}{\eV\s}\),
lo que representa un error relativo porcentual del \qty{3}{\percent}
respecto al valor de referencia \qty{4.136}{\eV\s} reportado en la literatura
\cite{bureau-international-des-poids-et-mesures-2018}.
Mientras que el valor de la función de trabajo es \(\phi = \qty{1.56}{\eV}\).
