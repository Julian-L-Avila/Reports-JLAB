...
"#U (kV)" => df[!, "U (kV)"],
"r1 (cm)" => round.(df[!, "r1"], digits = 2),
"r2 (cm)" => round.(df[!, "r2"], digits = 2),
...
main() = begin
  ...
  parameters_d_sp = 2.0 * 6.5 ./ slopes_sp
  ...
  parameters_d_li = 13.5 ./ slopes_li
  ...
  parameters_df = DataFrame(
                            ...
                            "d (pm)" => vcat(parameters_d_sp, parameters_d_li)
                           )
