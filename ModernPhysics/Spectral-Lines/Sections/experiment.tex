...
\begin{figure}[htbp!]
  \begin{center}
    \includegraphics[height=0.7\linewidth, page=2]{../Images/experimental-setup-H.jpg}
...
ubicando primero el cero del disco de Vernier, que indica el valor entero del 
ángulo. Para obtener el valor decimal, se seleccionó la división que mejor 
coincidiera con uno de los ángulos del disco y este número se multiplicó por 
0.5/30, obteniendo así el valor exacto del decimal.
...
\begin{figure}[htbp!]                                                           
  \begin{center}                                                              
    \includegraphics[height=0.7\linewidth, page=2]{../Images/experimental-setup-Na.jpg}
