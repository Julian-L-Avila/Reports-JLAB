...
divisiones por milímetro. Este montaje se muestra en la \cref{fig:experimental-setup}.

\begin{figure}[htbp!]
  \begin{center}
    \includegraphics[width=0.9\linewidth]{./Figures/experimental-setup.jpg}
...
espectrales entre los colores rojo, naranja y amarillo.
